...
public class SCalculator implements ActionListener {
    ...
    SCalculator() {
        ...
        functionButtons[24] = abstractButton;
        functionButtons[25] = sequareButton;
        ...
        for (int i = 0; i < 26; i++) {
            ...
            if (i < 10) {
                if (i == 5)
                    functionButtons[i].setBackground(ColorUIResource.GREEN);
        ...
        panel = new JPanel();
        panel.setBounds(80, 130, 600, 500);
